...
txt_adobe <- read.csv("https://raw.githubusercontent.com/wrathofquan/data-science-fellowship/master/Ross/data/txt_adobe.csv")
txt_hathi <- read.csv("https://raw.githubusercontent.com/wrathofquan/data-science-fellowship/master/Ross/data/txt_hathi.csv")
txt_gocr <- read.csv("https://raw.githubusercontent.com/wrathofquan/data-science-fellowship/master/Ross/data/txt_gocr.csv")
...
<center>
![Free proprietary software for UCB students!](https://raw.githubusercontent.com/wrathofquan/data-science-fellowship/master/Ross/code/screenshot.png)
</center>
...
If we check again, the number of rows is now almost identical. For Adobe: 
```{r, echo = FALSE }
nrow(txt_adobe)
```
And for Hathi:
...
Before moving further, lets store the raw text in a new variable so that we 
...
Much of the cleaning process simply involves removing unnecessary process.
...
Finally, we can identify the political party of each candidate 

```{r}

# Extracting the number of votes received by each candidate
txt_adobe$party <- str_sub( txt_adobe$text, -1, -1 )
txt_adobe$text <- str_sub( txt_adobe$text, 1, -2 )
txt_adobe$candidate <- gsub("^[[:blank:]]+|[[:blank:]]+$","",txt_adobe$text)

txt_hathi$party <- str_sub( txt_hathi$text, -1, -1 )
